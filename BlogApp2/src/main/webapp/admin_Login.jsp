...
<body>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <form action="${pageContext.request.contextPath}/login" method="post" onsubmit="return validateForm()" class="login-form">
            ...
            <p class="message">Don't have an account? <a href="admin_Register.jsp">Sign up here</a></p>
        </div>
    </div>
    <footer>
